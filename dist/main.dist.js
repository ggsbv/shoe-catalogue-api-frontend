...
function TheDOM() {
    ...
    var clearShoeInputFields = function () {
      shoeInputFields.forEach(function (elementSelector) {
    ...
    return {
        ...
        clearShoeInputFields: clearShoeInputFields
    }
}
 ...
 * Build: `lodash modularize exports="es" include="uniq"`
...
HandlebarsTemplate.prototype.sortUniqueShoeProperties = function sortUniqueShoeProperties (data) {
    var holder = {
        brand: [],
        size: [],
        color: []
...
HandlebarsTemplate.prototype.renderDropdowns = function renderDropdowns (outputElemSelector, data) {
...
/**
 * Lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="es" include="find"`
 * Copyright JS Foundation and other contributors <https://js.foundation/>
 * Released under MIT license <https://lodash.com/license>
 * Based on Underscore.js 1.8.3 <http://underscorejs.org/LICENSE>
 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
